...
#monofont: "Fira Code"        # for code chunks
colorlinks: true
linkcolor: blue
urlcolor: steelblue
citecolor: navy
...
For models like SVM and KNN, we need to scale the numeric features. Scaling numerical features (excluding the target and categorical variables)
